...
exports.PNCPProvider = void 0;
class PNCPProvider {
    nome = 'PNCP (Portal Nacional de Contratações Públicas - High Performance Search)';
    /**
     ...
     */
    async buscarEditais(termo, uf, status = 'recebendo_proposta', tipoDocumento = 'edital') {
        const todosItens = [];
        const tamPagina = 50;
        const maxPaginas = 3;
        ...
        for (let pagina = 1; pagina <= maxPaginas; pagina++) {
            try {
                ...
                const normalizados = rawItems.map((item) => {
...
exports.PNCPProvider = PNCPProvider;
